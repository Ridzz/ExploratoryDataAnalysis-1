##
## Source code for Assignment #1 - Exploratory Data Analysis - Plot 1
##
...
par(mfrow = c(1,1))
hist(pDataS$Global_active_power, main="Global Active Power",xlab="Global Active Power (killowatts)", ylab = "Frequency",col="red")
